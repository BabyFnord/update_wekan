...
#while true; do
      cd "$HOME"/wekan/current
      #---------------------------------------------
      # Debug OIDC OAuth2 etc.
      #export DEBUG=true
      #---------------------------------------------
      export MONGO_URL="mongodb://wekan:PASSWORD@127.0.0.1:27017/wekan"
      #---------------------------------------------
      # WRITEABLE PATH
      ...
      export ROOT_URL="https://your.wekan-instance.net"
      #---------------------------------------------
      # https://github.com/wekan/wekan/wiki/Troubleshooting-Mail
      # https://github.com/wekan/wekan-mongodb/blob/master/docker-compose.yml
      export MAIL_URL='smtp://wekan@your.domain:MAILPASSWORD@isabell.uberspace.de:587'
      export MAIL_FROM='Wekan Boards wekan@your.domain>'
